...
### Fixed
- BaseApp name derived from `umeshnode` binary is now `UmeshNodeApp` (previously produced the awkward `UmeshnodeApp`). This is the name written to `appName` in the generated `app/app.go`.
